...
import { buildAllResults, computeFunStats, computePowerRankings } from '@/shared/lib/stats/stats-engine'
...
export function Component() {
  ...
  if (isLoading) return <LoadingScreen message="LOADING LEAGUE DATA..." fullScreen />
  if (error) return <ErrorState message="Failed to load league data." onRetry={refetch} />
