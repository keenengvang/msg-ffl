...
import { buildAllResults } from '@/shared/utils/stats/stats-engine'
...
export function AchievementsPage() {
  ...
  const combinedLoading = profilesLoading || matchupsLoading || transactionsLoading || winnersLoading || losersLoading
  const combinedError = profilesError ?? matchupsError ?? transactionsError ?? winnersError ?? losersError

  if (combinedLoading) return <LoadingScreen message="COMPUTING BADGES..." />
  if (combinedError)
    return (
      <ErrorState
